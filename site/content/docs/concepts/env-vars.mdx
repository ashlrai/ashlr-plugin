...
| `ASHLR_MCP_HOST` | `claude-code` | MCP host identifier. Set to `cursor`, `claude-desktop`, or `openai-codex` for multi-host mode. Affects hook wiring and status-line rendering. |
