...
The free tier is not a trial. All 40 MCP tools, all 33 slash commands, local genome, and the savings ledger are included permanently. Pro adds cloud infrastructure on top.
