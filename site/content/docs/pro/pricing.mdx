...
The free tier is not a trial. All 35 MCP tools, all 30 skills, local genome, and the savings ledger are included permanently. Pro adds cloud infrastructure on top.
