---
title: What is ashlr?
description: Open-source Codex and Claude Code plugin that cuts token usage on file reads, greps, edits, and shell output — with opt-in telemetry.
---
...
Then install from the Claude Code marketplace or use the Codex plugin/MCP manifests. See [Install](/docs/getting-started/install) for the exact Codex, Claude Code, Cursor, and Goose variants and verification.
