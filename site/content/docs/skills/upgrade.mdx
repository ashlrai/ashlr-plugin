---
title: /ashlr-upgrade
description: Terminal-native free→Pro upgrade flow. GitHub OAuth or magic-link sign-in, plan selection, Stripe checkout (with 7-day Pro trial on first checkout), and activation polling — all under 90 seconds without leaving the terminal.
---
