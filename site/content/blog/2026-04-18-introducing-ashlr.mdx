---
title: "Why I built a token-efficiency layer for Codex and Claude Code"
date: "2026-04-18"
author: "Mason Wyatt"
description: "Token counts are a real operating cost. ashlr is the open-source plugin that fixes the read-everything problem in Codex and Claude Code — cutting mean token usage by 57% across TypeScript, Python, and Rust reference repos."
